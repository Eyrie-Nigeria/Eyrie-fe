...
export default function Login() {
  ...
  return (
    <ErrorBoundary
      fallback={
        <ErrorFallback componentName="Login Page" onReset={() => window.location.reload()} />
      }
    >
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3.5">
              ...
              >
                <Button
                  ...
                  className={`custom-button mt-1 text-white text-base font-semibold bg-[#ff5b20] hover:bg-[#FF4500] ${loginMutation.isPending || !form.formState.isValid ? 'bg-[#ff5b20] border-4 border-[#FF4500] shadow-lg cursor-not-allowed' : ''}`}
                >
